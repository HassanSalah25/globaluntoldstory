...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit Client Logo</h1>
    </div>

    <form action="{{ route('admin.client-logos.update', $clientLogo) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order"
                           value="{{ old('sort_order', $clientLogo->sort_order ?? 0) }}"
                           class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6" x-data="{ tab: 'en' }">
            ...
            <div x-show="tab==='en'">
                <div>
                    ...
                    <input type="text" name="display_name_en"
                           value="{{ old('display_name_en', $translations['en']->display_name ?? '') }}"
                           class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
            </div>
            ...
            <div x-show="tab==='ar'" dir="rtl">
                <div>
                    ...
                    <input type="text" name="display_name_ar"
                           value="{{ old('display_name_ar', $translations['ar']->display_name ?? '') }}"
                           class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
            </div>
        </div>
