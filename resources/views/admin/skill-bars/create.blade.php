...
@section('title', 'Add New Skill Bar')
...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Add New Skill Bar</h1>
    </div>

    <form action="{{ route('admin.skill-bars.store') }}" method="POST">
        @csrf
            ...
            <div x-show="tab==='ar'" dir="rtl">
                <div>
                    ...
                    <input type="text" name="label_ar"
                           value="{{ old('label_ar') }}"
                           placeholder="مثال: استراتيجية العلامة التجارية"
                           class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
            </div>
        </div>
