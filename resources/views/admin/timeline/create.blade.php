...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Add Timeline Event</h2>
            <p class="text-sm text-gray-500">Create a new company history milestone</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="year" value="{{ old('year') }}" required placeholder="e.g. 2020" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6" x-data="{ tab: 'en' }">
            ...
            <div x-show="tab === 'en'" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description_en" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('description_en') }}</textarea>
                </div>
            </div>
            ...
            <div x-show="tab === 'ar'" dir="rtl" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description_ar" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('description_ar') }}</textarea>
                </div>
            </div>
        </div>

        <div class="flex items-center gap-3">
            <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-lg font-medium">Create Event</button>
