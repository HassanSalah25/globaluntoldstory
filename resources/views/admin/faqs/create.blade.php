...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Add FAQ</h2>
            <p class="text-sm text-gray-500">Create a new frequently asked question</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6" x-data="{ tab: 'en' }">
            ...
            <div x-show="tab === 'en'" class="space-y-4">
                <div>
                    ...
                    <textarea name="question_en" rows="2" required class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('question_en') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Answer <span class="text-red-500">*</span></label>
                    <textarea name="answer_en" rows="4" required class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('answer_en') }}</textarea>
                </div>
            </div>
            ...
            <div x-show="tab === 'ar'" dir="rtl" class="space-y-4">
                <div>
                    ...
                    <textarea name="question_ar" rows="2" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('question_ar') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">الإجابة <span class="text-red-500">*</span></label>
                    <textarea name="answer_ar" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('answer_ar') }}</textarea>
                </div>
            </div>
        </div>

        <div class="flex items-center gap-3">
            <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-lg font-medium">Create FAQ</button>
