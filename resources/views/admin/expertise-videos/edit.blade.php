...
@section('title', 'Edit Expertise Video')
...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit Expertise Video</h1>
    </div>

    <form action="{{ route('admin.expertise-videos.update', $video) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                @include('admin.components.image-picker', [
                    ...
                    'value' => old('poster_url', $video->poster_url),
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            @include('admin.components.expertise-category-select', [
                'selectedEn' => old('tag_en', $translations['en']->tag ?? ''),
                'selectedAr' => old('tag_ar', $translations['ar']->tag ?? ''),
            ])
        </div>
