...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Update testimonial details</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="type" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                        ...
                        <option value="award" {{ old('type', $testimonial->type) === 'award' ? 'selected' : '' }}>Award</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Sort Order</label>
                    <input type="number" name="sort_order" value="{{ old('sort_order', $testimonial->sort_order) }}" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
                <div class="flex items-center gap-3 pt-6">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $testimonial->is_active) ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-red-600 focus:ring-red-500">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6" x-data="{ tab: 'en' }">
            ...
            <div x-show="tab === 'en'" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="text_en" rows="4" required class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('text_en', $translations['en']->text ?? '') }}</textarea>
                </div>
            </div>
            <div x-show="tab === 'ar'" dir="rtl" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="text_ar" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('text_ar', $translations['ar']->text ?? '') }}</textarea>
                </div>
            </div>
        </div>
