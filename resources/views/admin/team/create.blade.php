        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6" x-data="{ tab: 'en' }">
            ...
            <div x-show="tab === 'en'" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="role_en" value="{{ old('role_en') }}" placeholder="e.g. Head of SEO" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Bio</label>
                    <textarea name="bio_en" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('bio_en') }}</textarea>
                </div>
            </div>
            ...
            <div x-show="tab === 'ar'" dir="rtl" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="bio_ar" rows="4" class="border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm">{{ old('bio_ar') }}</textarea>
                </div>
            </div>
        </div>
